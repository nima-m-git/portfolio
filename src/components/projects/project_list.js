const applications = [
  {
    name: 'Portfolio',
    background:
      'https://cutewallpaper.org/21/80s-miami-wallpaper/80s-Retro-Wallpaper-Retro-Wave-Free-Wallpaper-.png',
    techs: ['React', 'Javascript', 'Sass', 'AWS'],
    codeURL: 'https://github.com/nima-m-git/portfolio-django/tree/master/parking_spot',
    viewURL: '',
  },
  {
    name: 'Blog API',
...
const design_clones = [
  {
    name: 'Newsweek',
    background:
      'https://hyperpix.net/wp-content/uploads/2020/07/newsweek-logo-font-free-download.jpg',
    techs: ['CSS', 'Bootstrap'],
...
const projects = [applications, design_clones];
